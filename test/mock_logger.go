...
var (
	...
	// TestInvalidJSON is a invalid json
	TestInvalidJSON = `{
		"name": "test1",
		"labels": {
			"testa": "testa1"
...
// Infow exposes a more flexible logger interface
func (logger MockLogger) Infow(s string, kv ...interface{}) {
	logger.Sugar.Infow(s, kv...)
}
